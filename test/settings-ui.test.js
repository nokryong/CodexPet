...
test("설정 창은 기존 디자인 구조 안에 테마, 설치 글꼴, 세 provider, 사용량을 제공한다", () => {
  assert.match(settingsHtml, /name="theme" value="light"/);
  assert.match(settingsHtml, /name="theme" value="dark"/);
  assert.match(settingsHtml, /name="theme" value="system"/);
  ...
  assert.match(settingsHtml, /VERSION 0\.3\.0/);
